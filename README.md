...
- **View**: Vistas desarrolladas con SwiftUI para representar las interfaces de usuario.
...
1. Encontrarás una lista de Usuarios a la cual podrás editar con un swipe a la izquierda para eliminar los usuarios deseados.
2. Encontrarás un botón flotante en la parte inferior derecha para agregar nuevos Usuarios.
