...
struct AddUserView: View {
    ...
    var body: some View {
        NavigationView { // Asegurando que la vista esté dentro de un NavigationView
            ZStack {
                VStack {
                    Form {
            ...
            .navigationTitle("Añadir Usuario") // Asegura que el título esté dentro del NavigationView
//            .navigationBarTitleDisplayMode(.inline) // Opcional: Mostrar el título de forma compacta
            .onAppear {
